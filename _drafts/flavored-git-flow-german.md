...
<center>
{% include image.html
            img="assets/git-flow-develop.png"
            title="develop"
            caption="Der develop-Branch entspringt dem master Branch" %}
</center>
...
<center>
{% include image.html
            img="assets/git-flow-feature.png"
            title="develop"
            caption="Hier sieht man ein Projekt in dem parallel an 2 feature Branches gearbeitet wurde. Der eine wurde bereits in den develop Branch gemerged während sich der andere noch in Entwicklung befindet." %}
</center>
...
<center>
{% include image.html
            img="assets/git-flow-support.png"
            title="develop"
            caption="Meist begegnet man SVN, Git oder Mercurial" %}
</center>
...
<center>
{% include image.html
            img="assets/git-flow-jamit-flavored.png"
            title="develop"
            caption="" %}
</center>
...
[Weitere anschauliche Erklärung zur Funktionsweise von Git Flow (basiert leider auf einer Konsolenbedienung von Git)](https://www.atlassian.com/pt/git/workflows#!workflow-gitflow)
